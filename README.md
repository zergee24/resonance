...
2026-09-26，0.2.3 已在真实网易云客户端跑通歌曲识别、自动录音、暂停后保存和频谱分析，重启后也能自动采集。0.2.4 修正单次 OCR 跳变引起的误切段，最终真机验收进度见 [TESTING.md](TESTING.md)。此前 IOProc 注册超时已在同一 0.2.3 版本、同一系统音频服务中恢复；恢复期间关闭后重新开启了窗口识别，尚不能据此认定超时根因。操作见 [使用说明](使用说明.md)。
