...
2026-09-26，0.2.3 已在真实网易云客户端验证日文和英文候选歌名、艺人、播放/暂停识别及窗口识别偏好恢复。当前自动采集仍在 Core Audio 的 IOProc 注册阶段超时，尚未通过自动录音与切歌分段验收。此前 0.2.2 在重启系统音频服务后通过了 8.8 秒 Lean On 片段采集、分析、拉斐尔匹配及新建歌单回读，另完成 194.6 秒连续录音；这些历史结果不代替当前自动采集验收。具体证据见 [TESTING.md](TESTING.md)，操作见 [使用说明](使用说明.md)。
