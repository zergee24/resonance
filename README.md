...
2026-09-26 在重启本机系统音频服务后，生产应用已通过 8.8 秒 Lean On 真实片段的采集、分析、拉斐尔匹配及新建歌单回读；另完成了 194.6 秒连续录音。辅助功能授权后的自动识别和切歌分段仍待真机验收；具体数据与此前超时记录见 [TESTING.md](TESTING.md)，恢复方法见 [使用说明](使用说明.md)。
